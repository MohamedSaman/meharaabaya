                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer justify-content-between" style="background: #fdfbf7; border-top: none; padding: 25px; border-bottom-left-radius: 12px; border-bottom-right-radius: 12px;">
                        ...
                        <div class="d-flex gap-2">
                            <button type="button" class="btn px-4 py-2" wire:click="printInvoice({{ $selectedSale->id }})" wire:loading.attr="disabled" wire:target="printInvoice({{ $selectedSale->id }})" style="background: white; border: 1px solid #c7952a; color: #c7952a; border-radius: 8px;">
