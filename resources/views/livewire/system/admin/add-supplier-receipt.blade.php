                    ...
                    <div class="card-body">
                        @if(count($selectedOrders) > 0)
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-lg">
                                    <span class="input-group-text">Rs.</span>
                                    <input type="number" class="form-control" wire:model.lazy="totalPaymentAmount" min="0" max="{{ $totalDueAmount - (float)$overpaymentToApply }}" step="0.01" placeholder="0">
                                </div>
                            ...
                            {{-- Payment Summary --}}
                            @if((float)$totalPaymentAmount > 0 || (float)$overpaymentToApply > 0)
                            <div class="border rounded p-3 bg-light mb-3">
                                <h6 class="fw-bold mb-2">Payment Summary</h6>
                                @if((float)$overpaymentToApply > 0)
                                <div class="d-flex justify-content-between align-items-center mb-1">
                                    <span class="text-muted">Overpayment Credit:</span>
                                    <span class="fw-bold text-success">Rs.{{ number_format((float)$overpaymentToApply, 2) }}</span>
                                </div>
                                @endif
                                @if((float)$totalPaymentAmount > 0)
                                <div class="d-flex justify-content-between align-items-center mb-1">
                                    <span class="text-muted">Cash Payment:</span>
                                    <span class="fw-bold">Rs.{{ number_format((float)$totalPaymentAmount, 2) }}</span>
                                </div>
                                @endif
                                <hr class="my-2">
                                <div class="d-flex justify-content-between align-items-center">
                                    <span class="fw-bold">Total Payment:</span>
                                    <span class="fw-bold text-primary">Rs.{{ number_format((float)$totalPaymentAmount + (float)$overpaymentToApply, 2) }}</span>
                                </div>
                            </div>
                        ...
                        <div class="mt-3">
                            ...
                            <div class="d-grid gap-2">
                                @php
                                    $remainingAfterOverpayment = $totalDueAmount - (float)$overpaymentToApply;
                                @endphp
                                <button
